...
import {useClickSidebar, useSideBar} from "@/store/sidebar/sidebarHooks";
...
export default function Home() {
    ...
    return (
        <div className="h-screen flex overflow-hidden bg-gray-100">
            ...
            <SidebarMobile isOpen={sidebarOpen.open} navigation={navigation} secondaryNavigation={secondaryNavigation}/>
            <SidebarDesktop isOpen={sidebarOpen.open} navigation={navigation}
                    ...
                    <div className="mt-8">
                      ...
                      <span className="flex items-center space-x-4">
                        <span className="flex-1 flex space-x-2 truncate">
                          <HiCash className="flex-shrink-0 h-5 w-5 text-gray-400" aria-hidden="true"/>
